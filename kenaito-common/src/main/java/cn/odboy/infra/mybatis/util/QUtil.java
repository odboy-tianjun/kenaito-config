package cn.odboy.infra.mybatis.util;
...
import cn.odboy.infra.mybatis.common.MpDataScope;
import cn.odboy.infra.mybatis.common.MpFilterUser;
import cn.odboy.infra.mybatis.common.MpQuery;
...
public class QUtil {
    ...
    public static <R, Q> QueryWrapper<R> build(Q query) {
        ...
        if (mds != null) {
            // 管理员放行
            if (!SystemConst.ADMIN.equals(SecurityUtil.getCurrentUsername())) {
                ...
                if (!field.isAccessible()) {
                    ...
                    if (filterUser != null) {
                        ...
                        try {
                            ...
                            if (SystemConst.ADMIN.equals(currentUsername)) {
                                continue;
                            }
    ...
    private static <R> void handleBlurryQuery(QueryWrapper<R> queryWrapper, String blurry, Object fieldVal) {
        List<String> blurryList = CollUtil.splitToList(blurry);
