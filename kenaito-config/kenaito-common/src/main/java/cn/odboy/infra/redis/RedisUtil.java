...
public class RedisUtil {
    ...
    public List<String> scan(String pattern) {
        ...
        try {
            ...
            log.error("redis scan 查找匹配key失败", e);
        }
        return result;
    }
