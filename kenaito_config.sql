...
-- ----------------------------
-- Table structure for config_app_user
-- ----------------------------
DROP TABLE IF EXISTS `config_app_user`;
CREATE TABLE `config_app_user`  (
  ...
  PRIMARY KEY (`app_id`, `user_id`, `env`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of config_app_user
-- ----------------------------
INSERT INTO `config_app_user` VALUES (1, 'daily', 1);
INSERT INTO `config_app_user` VALUES (1, 'prod', 1);
INSERT INTO `config_app_user` VALUES (1, 'stage', 1);
...
CREATE TABLE `config_file`  (
  ...
  `update_tim` datetime(0) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `config_file` VALUES (1, 1, 'daily', 'application-daily.properties', 1, 'admin', '2024-12-05 21:27:38', 'admin', '2024-12-05 21:27:38');
