...
CREATE TABLE `config_file`  (
  ...
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '配置文件' ROW_FORMAT = Dynamic;
...
INSERT INTO `config_file` VALUES (16, 1, 'stage', 'application-dev.yml', 2, 'admin', '2024-12-11 10:05:14', 'admin', '2024-12-11 10:05:14');
INSERT INTO `config_file` VALUES (18, 1, 'stage', 'application-dev.yml', 3, 'admin', '2024-12-11 10:18:11', 'admin', '2024-12-11 10:18:11');
INSERT INTO `config_file` VALUES (19, 1, 'stage', 'application-prod.yml', 2, 'admin', '2024-12-11 10:53:48', 'admin', '2024-12-11 10:53:48');
